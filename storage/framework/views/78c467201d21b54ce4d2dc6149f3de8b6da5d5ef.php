...
<div x-data="<?php echo e(json_encode(['show' => true, 'style' => $style, 'message' => $message])); ?>"
    :class="{ 'bg-green-500': style == 'success', 'bg-red-700': style == 'danger' }" style="display: none;"
...
</div><?php /**PATH /var/www/livewire-app/resources/views/vendor/jetstream/components/banner.blade.php ENDPATH**/ ?>