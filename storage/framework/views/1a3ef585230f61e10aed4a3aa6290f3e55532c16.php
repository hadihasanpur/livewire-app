...
<h1 class="text-center bg-white">mozayede</h1>
    <ul class="grid grid-cols-1 gap-1 sm:grid-cols-2 md:grid-cols-3 md:gap-8">
        ...
        <li class="bg-white dark:bg-gray-800 rounded-lg shadow-xl">
            <a href="<?php echo e(route('auction.show', $auction->slug)); ?>"
                ...
                <div><?php echo e($auction->file1); ?></div>
                <div class="mt-2">
                    ...
                    <div
                        ...
                        <h1
                            ...
                            <?php echo e($auction->title); ?></h1>
                        <p class="py-2 text-gray-700 dark:text-gray-400">
                            <?php echo e(Str::limit($auction->body, 90)); ?>
...
</div><?php /**PATH /var/www/livewire-app/resources/views/components/auction-list.blade.php ENDPATH**/ ?>