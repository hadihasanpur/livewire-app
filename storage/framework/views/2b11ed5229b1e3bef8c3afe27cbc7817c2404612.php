...
<section>
    ...
    <div class="pt-16 text-center md:pt-32">
        <h1 class="text-3xl font-bold text-blue-300 break-normal md:text-5xl"><?php echo e($post->title); ?></h1>
        <p class="text-sm font-bold text-green-500 md:text-base"><?php echo e($post->created_at); ?> <span
                class="text-gray-900">/</span> Created</p>
    </div>
    <!--image-->
    <img class="container w-full max-w-6xl mx-auto mt-8 bg-white bg-cover rounded"
        src="<?php echo e(asset('storage/photos/'. $post->image)); ?>" />
    <!--Container-->
...
<?php /**PATH /var/www/livewire-app/resources/views/livewire/post-show.blade.php ENDPATH**/ ?>